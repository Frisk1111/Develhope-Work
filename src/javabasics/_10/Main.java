...
public class Main {
    ...
    private static void exercise2() {
        ...
        int age = 30;
        double eurosInPocket = 15.5;
        double eurosForEntry = 10;
        boolean canEntry = eurosInPocket >= eurosForEntry;

        // Write your code here
        if (shoeType.equals("fancy") && age>18 && canEntry){  //.euquals è come scrivere "=="
    ...
    private static void exercise3() {
        ...
        double ourTestScoreAsAPercentage = (ourTestScore*100)/maxTestScore;
        if (isTestRetry){
            System.out.println("C"); //se isTestRetry è vera allora stamperà sempre C
        } if (ourTestScoreAsAPercentage >= 90 && !isTestRetry ) {
            System.out.println("A");
        } else if (ourTestScoreAsAPercentage >= 80 && ourTestScoreAsAPercentage <90 && !isTestRetry){
            System.out.println("B");
        } else if ( 70 <= ourTestScoreAsAPercentage && ourTestScoreAsAPercentage < 80 && !isTestRetry){
            System.out.println("C");
        } else if (ourTestScoreAsAPercentage >=60 && ourTestScoreAsAPercentage <70 && !isTestRetry){
            System.out.println("D");
        }else if (ourTestScoreAsAPercentage < 60 && !isTestRetry){
