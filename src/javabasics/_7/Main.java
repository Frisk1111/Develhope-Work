...
public class Main {
    ...
    private static void exercise1() {
        ...
        String phrase= "Hi, how are you today??";
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "Fabiola";
        String middleName = "Sara";
        String lastName = "Stazi";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "" + 6.6 +  1 + 4 + false; // <--- Edit this line
    ...
    private static void exercise4() {
        ...
        String fullNumbers= earlyNumbers + " " +middleNumbers.trim() + " " + endNumbers;
        System.out.println(fullNumbers); // <--- Write your code here
    }
